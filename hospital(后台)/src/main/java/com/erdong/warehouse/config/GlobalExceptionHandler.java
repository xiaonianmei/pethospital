package com.erdong.warehouse.config;


import com.erdong.warehouse.exception.BattcnException;
import com.erdong.warehouse.model.ApiResult;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ApiResult jsonErrorHandler(Exception e, HttpServletResponse rep) throws Exception {
        ...
        if (e instanceof MethodArgumentNotValidException) {
            ...
            rep.setStatus(HttpStatus.BAD_REQUEST.value());
            return ApiResult.getFailure(rep.getStatus(), "图片大小不能超过2M");
        }
